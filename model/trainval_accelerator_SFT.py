...
def trainval(cfg):
    ...
    # 测试高层接口
    print(sent_tokenize("Hello world. This works!"))
    import torch
    ...
    print(tokenizer.tokenize("Hello world. This works!"))
    ...
    if cfg.resume_from_checkpoint:
        ...
        # 计算从哪个epoch恢复
        training_difference = os.path.basename(os.path.normpath(cfg.resume_from_checkpoint))
    ...
    for epoch in range(starting_epoch, cfg.num_train_epochs):
        ...
        if cfg.checkpointing_steps == "epoch":
            ...
            accelerator.save_state(checkpoint_path_epoch)  # 会保存为下一个epoch
